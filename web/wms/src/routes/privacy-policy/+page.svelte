<div class="p-12">
	<div class="header">
		<div class="container">
			<p class="title">Privacy Policy for Wallmarkt</p>
		</div>
	</div>
	<div class="translations-content-container">
		<div class="container">
			<div class="space-y-4" id="en">
				...
				<ul>
					...
					<li>
						<p>
							...
							Agreement) refers to Wallmarkt, Koestraat 1a, 5298 AR.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Wallmarkt, accessible from
							<a href="localhost:5173" rel="external nofollow noopener" target="_blank"
								>localhost:5173</a
							>
						</p>
					</li>
				...
				<h2>Why are we using your data</h2>
				<p>
					We are required to use your data to process orders and are legally obligated to keep
					records of invoices for the government. Therefore full deletion of data is impossible once
					and order is finished. Wallmarkt is the only service that has access to the order details.
					All user data related to log in is stored at Auth0.
				</p>
				<h2>Contact Us</h2>
				<p>If you have any questions about this Privacy Policy, You can contact us:</p>
				<ul>
					<li>
						<p>By email: rensgiersbergen@gmail.com</p>
					</li>
					<li>
						<p>By phone number: +31651402617</p>
					</li>
				</ul>
			</div>
		</div>
